...
public class RoleDao extends AbstractDao<Role> {
    private final static String SQL_FIND_ALL_ROLES = "SELECT * FROM monitorsensors.roles";
    private final static String SQL_CREATE_ROLE = "INSERT INTO roles (Role) VALUES (?);";
    private final static String SQL_FIND_ROLE_BY_ID = "SELECT * FROM monitorsensors.roles WHERE id = ?;";
    private final static String SQL_DELETE_ROLE_BY_ID = "DELETE FROM monitorsensors.roles WHERE id=?;";
