...
<div class="container-fluid">
    <div class="col-md-6 col-md-offset-6">
        <table class="table table-condensed table-bordered">
            ...
            <c:forEach items="${sensorTypesList}" varStatus="сounter">
                <tr>
                    <td align="center" style="border-color: #dae5ff">${sensorTypesList[сounter.count-1].id}</td>
                    <td align="center" style="border-color: #dae5ff">${sensorTypesList[сounter.count-1].type}</td>
